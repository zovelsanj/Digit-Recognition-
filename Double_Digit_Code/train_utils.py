...
class Flatten(nn.Module):
    """A custom layer that views an input as 1D.
        Maps a higher dimensional tensor into an N x d one, where N is the number of samples in your batch and d is the length of the flattend dimension.
        If your tensor is N x h x w, the flattened dimension is  d=(h⋅w).
    """    
